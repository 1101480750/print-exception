package com.ym.print.response;

import com.alibaba.fastjson.annotation.JSONField;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.ym.print.constant.CodeConstant;
import com.ym.print.utils.string.YazuoStringUtils;
import lombok.Data;
...
public class RestResponse<T> implements Serializable {
     ...
     * @return
     */
    public static <T> RestResponse<T> buildWithCode(String code, String message) {
        RestResponse<T> rr = new RestResponse<T>(code, message);
    ...
    public boolean isSuccess() {
        if (this.header == null || StringUtils.isBlank(header.getCode())) {
            return false;
        }

        return StringUtils.equals(header.getCode(), CodeConstant.SUCCESS);
    }
